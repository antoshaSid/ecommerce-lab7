...
public class AdminControllerTest {
    ...
    public void deletePerfume() throws Exception {
        mockMvc.perform(
                MockMvcRequestBuilders.delete(PathConstants.API_V1_ADMIN + PathConstants.DELETE_BY_PERFUME_ID, 46)
                        .contentType(MediaType.APPLICATION_JSON_VALUE))
                .andExpect(status().isOk())
    ...
    public void deletePerfume_ShouldNotFound() throws Exception {
        mockMvc.perform(
                MockMvcRequestBuilders.delete(PathConstants.API_V1_ADMIN + PathConstants.DELETE_BY_PERFUME_ID, 99)
                        .contentType(MediaType.APPLICATION_JSON_VALUE))
    ...
    public void getUserById() throws Exception {
        mockMvc.perform(
                MockMvcRequestBuilders.get(PathConstants.API_V1_ADMIN + PathConstants.USER_BY_ID, TestConstants.USER_ID)
                        .contentType(MediaType.APPLICATION_JSON_VALUE))
                .andExpect(status().isOk())
