...
import com.asidliar.lab7.ecommerce.dto.PasswordResetRequest;
import com.asidliar.lab7.ecommerce.dto.auth.AuthenticationRequest;
...
public class AuthenticationControllerTest {
    ...
    public void forgotPassword() throws Exception {
        mockMvc.perform(
                MockMvcRequestBuilders.get(PathConstants.API_V1_AUTH + PathConstants.FORGOT_EMAIL, TestConstants.USER_EMAIL)
                        .contentType(MediaType.APPLICATION_JSON_VALUE))
                .andExpect(status().isOk())
    ...
    public void forgotPassword_ShouldEmailBeNotValid() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(
                    PathConstants.API_V1_AUTH + PathConstants.FORGOT_EMAIL, TestConstants.EMAIL_FAILURE)
                        .contentType(MediaType.APPLICATION_JSON_VALUE))
    ...
    public void getPasswordResetCode() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(
                    PathConstants.API_V1_AUTH + PathConstants.RESET_CODE, TestConstants.USER_PASSWORD_RESET_CODE)
                        .contentType(MediaType.APPLICATION_JSON_VALUE))
                .andExpect(status().isOk())
